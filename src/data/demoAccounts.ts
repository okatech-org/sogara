...
export const demoAccounts: DemoAccount[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Gestion des incidents HSE (approuve LOW/MEDIUM, escale HIGH/CRITICAL)',
      'Organisation et coordination des formations HSE',
      'Conduction des audits terrain opérationnels',
      'Gestion des données HSE et production des rapports',
      'Suivi des habilitations HSSE',
      'Inspection des équipements de sécurité HSE',
      'Validation des habilitations HSSE opérationnelles',
      'Coordination avec les équipes HSSE',
      'Escalade des incidents critiques vers HSE001',
    ],
    accessSummary: 'Accès : Module HSE, Formations HSSE, Données HSE, Rapports HSE, Audits Opérationnels',
