    ...
    try {
      ...
      try {
        ...
        if (convexResult) {
          ...
          toast({
            title: 'Connexion Convex réussie',
            description: `Bienvenue ${found.firstName} ${found.lastName}`,
          })
          return
        }
      } catch (_) {
      ...
      const employee = employees.find(
        emp => emp.matricule.toLowerCase() === matricule.toLowerCase(),
      )
      if (employee) {
        login(employee)
  ...
  return (
    <div className="min-h-screen bg-gradient-card flex items-center justify-center p-4">
      <div className="w-full max-w-6xl">
        {/* Back Button */}
        <div className="mb-6">
          <Button variant="ghost" onClick={onBackToHome} className="gap-2 hover:bg-white/80">
          ...
          <Card className="industrial-card-elevated">
            <CardHeader className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Accédez à votre espace SOGARA Access</p>
              </div>
            </CardHeader>
