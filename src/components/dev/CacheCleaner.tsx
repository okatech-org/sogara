  ...
  return (
    <Card className="border-yellow-200 bg-yellow-50/50">
      ...
      <CardContent className="space-y-4">
        <Alert>
          <AlertDescription>
            Si vous voyez des données incorrectes (anciens noms, doublons), utilisez ces boutons pour forcer le rechargement.
          </AlertDescription>
        </Alert>
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <p>💡 <strong>Recharger Employés</strong>: Efface le cache des employés uniquement</p>
          <p>💡 <strong>Tout Nettoyer</strong>: Efface tout le cache (employés, visites, colis, etc.)</p>
