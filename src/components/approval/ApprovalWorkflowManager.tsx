                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className={getStatusColor(step.status)}>
                          {step.status === 'pending' ? 'En attente' : 
                           ...
                           step.status === 'rejected' ? 'Rejeté' : 'Ignoré'}
                        </Badge>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        <strong>Approbateur:</strong> {step.approver.firstName} {step.approver.lastName}
                      </p>
                      {step.dueDate && (
                        <p className="text-sm text-muted-foreground">
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong>Demandeur:</strong> {workflow.requester.firstName} {workflow.requester.lastName}
                      </p>
                      <p className="text-sm text-muted-foreground">
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong>Terminé le:</strong> {new Date(workflow.updatedAt).toLocaleDateString()}
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <Button variant="outline" size="sm">
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong>Type:</strong> {workflow.type} | <strong>Étape:</strong> {workflow.currentStep}/{workflow.totalSteps}
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <Button variant="outline" size="sm">
