...
import { Home, Users, Calendar, Package, HardHat, Shield, Newspaper, FileText, Menu, X, BookOpen, Award, DollarSign, CalendarDays } from 'lucide-react';
...
const navigationItems: NavigationItem[] = [
  ...
  { id: 'mes-formations-ext', label: 'Formations', icon: BookOpen, requiredRoles: ['EXTERNE'], path: '/app/formations-externes' },
  { id: 'mes-evaluations-ext', label: 'Évaluations', icon: FileText, requiredRoles: ['EXTERNE'], path: '/app/evaluations-externes' },
  { id: 'mes-habilitations-ext', label: 'Habilitations', icon: Award, requiredRoles: ['EXTERNE'], path: '/app/habilitations-externes' },
  
  // Section Employé
  { id: 'mon-planning', label: 'Mon Planning', icon: CalendarDays, requiredRoles: ['EMPLOYE'], path: '/app/mon-planning' },
  { id: 'ma-paie', label: 'Ma Paie', icon: DollarSign, requiredRoles: ['EMPLOYE'], path: '/app/ma-paie' },
  { id: 'mes-formations', label: 'Mes Formations HSE', icon: BookOpen, requiredRoles: ['EMPLOYE'], path: '/app/mes-formations' },
  { id: 'mes-equipements', label: 'Mes Équipements', icon: HardHat, requiredRoles: ['EMPLOYE'], path: '/app/mes-equipements' },
  { id: 'mes-habilitations', label: 'Mes Habilitations', icon: Award, requiredRoles: ['EMPLOYE'], path: '/app/mes-habilitations' },
  
  // Section Gestion
  { id: 'personnel', label: 'Personnel', icon: Users, requiredRoles: ['ADMIN', 'HSE', 'SUPERVISEUR', 'DRH'], path: '/app/personnel' },
  { id: 'planning', label: 'Planning Global', icon: CalendarDays, requiredRoles: ['ADMIN', 'DRH', 'DG'], path: '/app/planning' },
  { id: 'paie', label: 'Gestion Paie', icon: DollarSign, requiredRoles: ['ADMIN', 'DRH', 'DG'], path: '/app/paie' },
