...
import { BookOpen, Clock, Users, Award, AlertTriangle, CheckCircle, Filter, Search } from 'lucide-react';
...
export function HSETrainingCatalog({ trainings, onScheduleSession, canManage = false }: HSETrainingCatalogProps) {
  ...
  const filteredModules = trainingModules.filter(module => {
    ...
    const matchesRole = selectedRole === 'all' || 
      module.requiredForRoles.includes(selectedRole as UserRole);
      ...
      >
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between">
            ...
            {hasUpcoming && (
              <StatusBadge status="Programmé" variant="info" />
            )}
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                {module.certification.examRequired ? 'Examen requis' : 'Attestation'}
              </span>
            </div>
          </div>
        ...
        <CardContent>
          <div className="space-y-3 text-sm">
            <div>
              ...
              <p className="text-muted-foreground mt-1">{module.instructor.qualificationRequired}</p>
            </div>
            <div>
