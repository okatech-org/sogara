  ...
  const renderOverviewCards = () => (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <Card className="industrial-card">
        ...
        <CardContent>
          <div className="text-3xl font-bold text-orange-600">{employeesNeedingAction.length}</div>
      ...
      <Card className="industrial-card">
        ...
        <CardContent>
          ...
          <div className="text-xs text-muted-foreground mt-2">Certificats expirés</div>
        </CardContent>
      </Card>
      ...
      <Card className="industrial-card">
        ...
        <CardContent>
          ...
          <div className="text-xs text-muted-foreground mt-2">Dans les 30 prochains jours</div>
        </CardContent>
      </Card>
    </div>
  )
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="matrix" className="space-y-4">
        ...
        <TabsContent value="matrix">
          <HSEComplianceMatrix employees={state.employees} trainings={state.hseTrainings} />
        </TabsContent>
        ...
        <TabsContent value="services" className="space-y-4">
          <Card className="industrial-card">
            ...
            <CardContent>{renderServiceCompliance()}</CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="industrial-card">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Badge variant="destructive">{employeesNeedingAction.length} employé(s)</Badge>
              </div>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-3">
                  {complianceReport.servicesNeedingAttention.map(service => (
                    ...
                    >
                      ...
                      <StatusBadge status={`${service.complianceRate}%`} variant="urgent" />
                    </div>
                  ))}
                </div>
              </CardContent>
