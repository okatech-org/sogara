...
const incidentFormSchema = z.object({
  ...
  location: z.string().min(5, 'Localisation requise').max(200, 'Localisation trop longue'),
  occurredAt: z.date({
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      ...
                      <p>
                        ...
                        {employees.find(e => e.id === watch('employeeId'))?.firstName}{' '}
                        {employees.find(e => e.id === watch('employeeId'))?.lastName}
                      </p>
                      <p>
                        <AlertTriangle className="w-3 h-3 inline mr-1" />
                        <strong>Gravité:</strong>{' '}
                        {SEVERITY_LEVELS.find(s => s.value === watchedSeverity)?.label}
                      </p>
                    </div>
