              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="text-sm">
                    <p>
                      <strong>Document:</strong> {visitor.idDocument} (
                      {visitor.documentType.toUpperCase()})
                    </p>
                    {visitor.phone && (
                      <p>
                        <strong>Téléphone:</strong> {visitor.phone}
                      </p>
                    )}
                    {visitor.email && (
                      <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>
                  ...
                  {format(visit.scheduledAt, 'EEEE d MMMM yyyy', { locale: fr })}
                </span>
              </div>
              ...
              <div>
                <Badge variant="outline">{hostEmployee.service}</Badge>
              </div>
            </div>
          ...
          <Card className="bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">
                ...
                va être enregistré comme <strong>présent sur site</strong> avec le badge{' '}
                <strong>{badgeNumber || '[À définir]'}</strong>.
              </p>
            </CardContent>
          </Card>
