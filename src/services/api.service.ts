...
export const authAPI = {
  ...
  register: (employeeData: any) => 
    apiService.post('/auth/register', employeeData),
...
export const employeesAPI = {
  ...
  getById: (id: string) => 
    apiService.get(`/employees/${id}`),
    
  create: (employeeData: any) => 
    apiService.post('/employees', employeeData),
    
  update: (id: string, employeeData: any) => 
    apiService.put(`/employees/${id}`, employeeData),
    
  delete: (id: string) => 
    apiService.delete(`/employees/${id}`),
    
  getByRole: (role: string) => 
    apiService.get(`/employees/by-role/${role}`),
    
  getStats: () => 
    apiService.get('/employees/stats'),
...
export const visitsAPI = {
  ...
  create: (visitData: any) => 
    apiService.post('/visits', visitData),
    
  update: (id: string, visitData: any) => 
    apiService.put(`/visits/${id}`, visitData),
    
  updateStatus: (id: string, status: string, data?: any) => 
    apiService.patch(`/visits/${id}/status`, { status, ...data }),
    
  getTodaysVisits: () => 
    apiService.get('/visits/today'),
    
  getByDate: (date: string) => 
    apiService.get(`/visits/by-date/${date}`),
    
  checkIn: (id: string, badgeNumber?: string) => 
    apiService.post(`/visits/${id}/check-in`, { badgeNumber }),
    
  checkOut: (id: string, notes?: string) => 
    apiService.post(`/visits/${id}/check-out`, { notes })
};
