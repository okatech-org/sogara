  ...
  const myVacations = useMemo(() => {
    return vacations
      .filter(v => {
        ...
        return v.employeeId === currentUser?.id &&
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Mes vacations et horaires de travail
        </p>
      </div>
          ...
          <Card className="industrial-card">
            <CardContent className="text-center py-16">
              ...
              <p className="text-muted-foreground">
                Vos vacations pour ce mois apparaîtront ici.
              </p>
            </CardContent>
          </Card>
        ) : (
                  ...
                  <CardContent className="p-5">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm text-muted-foreground">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>
                              {new Date(vacation.startTime).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}
                              {' - '}
                              {new Date(vacation.endTime).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}
                            </span>
                          </div>
                          <div className="flex items-center gap-1">
                      ...
                      <div className="flex gap-2">
                        ...
                        {vacation.status === 'IN_PROGRESS' && vacation.checkInTime && !vacation.checkOutTime && (
                          <Button 
                            onClick={() => {
                              const duration = (Date.now() - vacation.checkInTime!.getTime()) / (1000 * 60 * 60);
