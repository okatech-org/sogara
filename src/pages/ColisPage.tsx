    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gestion des réceptions et remises</p>
        </div>
        {canManagePackages && (
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-medium text-foreground">{pkg.reference}</h3>
                          {pkg.priority === 'urgent' && (
                        ...
                        <div className="text-sm text-muted-foreground">
                          ...
                          <p>
                            Pour:{' '}
                            {pkg.recipientEmployeeId
                              ? getRecipientName(pkg.recipientEmployeeId)
                              : pkg.recipientService || 'Destinataire inconnu'}
                          </p>
                          {pkg.type === 'mail' && (
                          ...
                          {pkg.deliveredAt && (
                            <p>
                              Remis: {new Date(pkg.deliveredAt).toLocaleString()} par{' '}
                              {pkg.deliveredBy}
                            </p>
                          )}
                        </div>
