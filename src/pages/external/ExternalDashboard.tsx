...
import { FileCheck, Award, Building, User, Mail, Phone, Clock, CheckCircle, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-yellow-800">
                  Vous devez compléter ces tests pour obtenir les autorisations d'accès à la raffinerie
                </p>
              </div>
              <Button 
                size="sm" 
      ...
      <Card className="industrial-card bg-blue-50/50 border-blue-200">
        <CardHeader>
          <CardTitle className="text-blue-900">Informations Importantes - Accès Raffinerie</CardTitle>
        </CardHeader>
        <CardContent className="space-y-2 text-sm text-blue-800">
          <p>• <strong>Tests obligatoires:</strong> Vous devez réussir tous les tests assignés (score ≥ 80%)</p>
          <p>• <strong>Correction:</strong> Les questions à réponse libre sont corrigées par le Responsable HSE</p>
          <p>• <strong>Résultats:</strong> Vous recevrez vos résultats par email sous 24-48 heures</p>
          <p>• <strong>Certificats:</strong> Les habilitations sont valables 12 mois à compter de la réussite</p>
          <p>• <strong>Accès site:</strong> Présentez vos certificats à l'accueil de la raffinerie</p>
          <p>• <strong>Sécurité:</strong> Le respect strict des procédures de sécurité est obligatoire</p>
        </CardContent>
      </Card>
    </div>
  );
