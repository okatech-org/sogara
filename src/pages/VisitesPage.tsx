    ...
    if (visit.status === 'waiting') {
      ...
      return (
        <CheckInVisitorDialog
          ...
          hostEmployee={host}
          trigger={
            <Button size="sm" variant="default" className="gap-2" disabled={isUpdating}>
              {isUpdating ? loadingIcon : null}
              Enregistrer entrée
            </Button>
          }
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Les visites ont été rechargées avec succès.',
      })
    } catch (error) {
      toast({
        title: 'Erreur',
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-muted-foreground">
                                <p>
                                  Hôte:{' '}
                                  {host ? `${host.firstName} ${host.lastName}` : 'Hôte inconnu'}
                                </p>
                        ...
                        {visit.checkedInAt && (
                          <div className="mt-3 text-xs text-muted-foreground">
                            ...
                            {visit.checkedOutAt && (
                              <span>
                                {' '}
                                • Sortie: {new Date(visit.checkedOutAt).toLocaleTimeString()}
                              </span>
                            )}
                          </div>
                        )}
                          ...
                          <div className="flex gap-3 flex-1">
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              <div className="text-sm text-muted-foreground space-y-1">
                                {visitor.company && (
                                  <p>
                                    <strong>Société:</strong> {visitor.company}
                                  </p>
                                )}
                                <p>
                ...
                {aiVisitors.length === 0 && (
                  <div className="text-center py-12 text-muted-foreground">
                    ...
                    <p className="text-sm mt-2">
                      Utilisez le bouton "Enregistrer avec IA" pour commencer
                    </p>
                  </div>
                )}
              </div>
