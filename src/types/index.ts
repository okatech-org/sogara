export type UserRole = 'ADMIN' | 'RECEP' | 'HSE' | 'SUPERVISEUR' | 'EMPLOYE' | 'COMMUNICATION' | 'DG' | 'DRH' | 'COMPLIANCE' | 'SECURITE' | 'EXTERNE';
...
export type HSEAssignmentStatus = 'sent' | 'received' | 'read' | 'in_progress' | 'completed' | 'expired' | 'acknowledged';
